...
export function ErrorState({
  ...
  return (
    <div
      className="flex flex-col gap-3 rounded-3xl bg-white/85 p-5 shadow-sm shadow-stone-900/5 dark:bg-zinc-900/75"
      role="alert"
    >
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-3xl bg-white/70 p-5 dark:bg-zinc-900/60">
