...
export const restaurantFrA2: ScenarioLocaleContent = {
  worldId: "france",
  ...
  fixtureOpeningLine:
    "Bonjour ! Vous avez une réservation, ou je vous installe ?",
  character: {
    id: "camille",
    name: "Camille",
    ...
    communicationStyle: {
      en: "Polite restaurant French. Use vous at this level. Short, clear offers.",
    },
    ...
    persona: {
      en: "You are a friendly waiter/waitress in a French restaurant. Use vous at this level. Help the guest sit, order food and a drink, explain a menu item simply, and bring the bill. If a dish is unavailable, say so naturally. Do not switch into a language teacher.",
    },
  },
  mission: {
    id: "order_meal",
    ...
    context: {
      en: "You visit a restaurant in France and need to order food and a drink.",
    },
    goal: {
  ...
  vocabularyHints: [
    { term: "carte", meaningEn: "menu" },
    { term: "commander", meaningEn: "to order" },
    { term: "boisson", meaningEn: "drink" },
    { term: "addition", meaningEn: "bill" },
    { term: "payer", meaningEn: "to pay" },
    { term: "plat", meaningEn: "dish" },
  ],
  culturalContext: {
    formality: "formal",
    interactionStyle: "Guests typically use vous with waiting staff at this level.",
    commonTerms: ["carte", "commander", "addition"],
